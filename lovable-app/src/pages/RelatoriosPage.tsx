...
import type { RelatorioMensal, RelatorioParcelasDetalhe } from "../types";
...
export default function RelatoriosPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const payload = (await response.json()) as ApiPayload<RelatorioMensal>;
  ...
  const loadParcelasDetalhe = useCallback(
    async (targetMonth: string) => {
      ...
      try {
        ...
        const payload = (await response.json()) as ApiPayload<RelatorioParcelasDetalhe>;
